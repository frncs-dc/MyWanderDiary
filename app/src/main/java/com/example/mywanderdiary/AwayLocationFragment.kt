...
class AwayLocationFragment : Fragment(R.layout.activity_start_away_radius), OnMapReadyCallback {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        addressInput = view.findViewById(R.id.activity_start_et_address)
        ...
        // TODO: Set button listener for saving the radius set
        view.findViewById<Button>(R.id.activity_start_away_radius_btn_set).setOnClickListener {
            findOnMap()
        }

        // TODO: Check if you still need to start location service (since it's already started in the previous screen)
    ...
    // TODO: Check if still required for this away radius part. Remove if no longer needed
    ...
    private fun findOnMap() {
        ...
        try {
            ...
            Log.e("AwayLocationFragment", "Geocoding failed", e)
